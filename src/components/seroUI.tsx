...
const SeroUI = () => {
  ...
  const [loadingProduct, setLoadingProduct] = useState<ProductType>({name:'',number:''});
  ...
  return (
    <div className="container">
      ...
      <div className="status">
        <h3>Product No.</h3>
        {loading?
        <input  onChange={(e)=>setLoadingProduct({...loadingProduct,number:e.target.value})}/>:
      ...
      <div className="status">
        <h3>Name</h3>
        {loading?
        <input onChange={(e)=>setLoadingProduct({...loadingProduct,name:e.target.value})}/>:
      ...
      <div className="buttonList">
        ...
        <button type="button" className={movingStatus?"Stop":"Move"} onClick={onClickStop}>
